		...
		public ActionResult Index(Order order)
		{
			...
			if (ModelState.IsValid)
			{
                ...
                if (result > 0)
                {
                    ...
                    string main = String.Format(@"<h2 class='title'>Coffee Beans RXTU -Xác Nhận Đơn Hàng</h2>
                <p>
				...
				<p>
                    ...
                    HelpMail.SendEmail(currentUser.Email, "chaudang0000@gmail.com", "chauhaidang", "[Coffee Beans RXTU]_Đơn hàng", header + main + footer);
