...
namespace FormCoffee {
    ...
    public partial class OrderDetailsDataSet : global::System.Data.DataSet {
        ...
        public partial class OrderDetailsDataTable : global::System.Data.TypedTableBase<OrderDetailsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderDetailsRow AddOrderDetailsRow(int Product_Id, int Oder_ID, float Price, double Quantity) {
        ...
        public partial class OrderDetailsRow : global::System.Data.DataRow {
            ...
            public int Oder_ID {
                get {
                    return ((int)(this[this.tableOrderDetails.Oder_IDColumn]));
                }
                set {
                    this[this.tableOrderDetails.Oder_IDColumn] = value;
                }
            }
...
namespace FormCoffee.OrderDetailsDataSetTableAdapters {
    ...
    public partial class OrderDetailsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[OrderDetails] WHERE (([ID] = @Original_ID) AND ([Product_Id] =" +
                " @Original_Product_Id) AND ([Oder_ID] = @Original_Oder_ID) AND ([Price] = @Origi" +
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Oder_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Oder_ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[OrderDetails] ([Product_Id], [Oder_ID], [Price], [Quantity]) V" +
                "ALUES (@Product_Id, @Oder_ID, @Price, @Quantity);\r\nSELECT ID, Product_Id, Oder_I" +
                "D, Price, Quantity FROM OrderDetails WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Oder_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Oder_ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[OrderDetails] SET [Product_Id] = @Product_Id, [Oder_ID] = @Oder_ID, [Price] = @Price, [Quantity] = @Quantity WHERE (([ID] = @Original_ID) AND ([Product_Id] = @Original_Product_Id) AND ([Oder_ID] = @Original_Oder_ID) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity));
SELECT ID, Product_Id, Oder_ID, Price, Quantity FROM OrderDetails WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Oder_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Oder_ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Oder_ID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Oder_ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Product_Id, Oder_ID, Price, Quantity FROM dbo.OrderDetails";
        ...
        public virtual int Fill(OrderDetailsDataSet.OrderDetailsDataTable dataTable) {
        ...
        public virtual OrderDetailsDataSet.OrderDetailsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OrderDetailsDataSet.OrderDetailsDataTable dataTable = new OrderDetailsDataSet.OrderDetailsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OrderDetailsDataSet.OrderDetailsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, int Original_Product_Id, int Original_Oder_ID, float Original_Price, double Original_Quantity) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ID));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_Product_Id));
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_Oder_ID));
        ...
        public virtual int Insert(int Product_Id, int Oder_ID, float Price, double Quantity) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Product_Id));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(Oder_ID));
        ...
        public virtual int Update(int Product_Id, int Oder_ID, float Price, double Quantity, int Original_ID, int Original_Product_Id, int Original_Oder_ID, float Original_Price, double Original_Quantity, int ID) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Product_Id));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Oder_ID));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_Oder_ID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Product_Id, int Oder_ID, float Price, double Quantity, int Original_ID, int Original_Product_Id, int Original_Oder_ID, float Original_Price, double Original_Quantity) {
            return this.Update(Product_Id, Oder_ID, Price, Quantity, Original_ID, Original_Product_Id, Original_Oder_ID, Original_Price, Original_Quantity, Original_ID);
        }
    }
