...
namespace FormCoffee {
    ...
    public partial class CategoryDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation _relationFK_dbo_Categories_dbo_Categories_ParentID;
        ...
        internal void InitVars(bool initTable) {
            ...
            this._relationFK_dbo_Categories_dbo_Categories_ParentID = this.Relations["FK_dbo.Categories_dbo.Categories_ParentID"];
        }
        ...
        private void InitClass() {
            ...
            this._relationFK_dbo_Categories_dbo_Categories_ParentID = new global::System.Data.DataRelation("FK_dbo.Categories_dbo.Categories_ParentID", new global::System.Data.DataColumn[] {
                        this.tableCategories.IDColumn}, new global::System.Data.DataColumn[] {
                        this.tableCategories.ParentIDColumn}, false);
            this.Relations.Add(this._relationFK_dbo_Categories_dbo_Categories_ParentID);
        }
        ...
        public partial class CategoriesDataTable : global::System.Data.TypedTableBase<CategoriesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CategoriesRow AddCategoriesRow(string Name, string Slug, CategoriesRow _parentCategoriesRowByFK_dbo_Categories_dbo_Categories_ParentID, bool Status, System.DateTime CreatedDate, System.DateTime ModifileDate) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        CreatedDate,
                        ModifileDate};
                if ((_parentCategoriesRowByFK_dbo_Categories_dbo_Categories_ParentID != null)) {
                    columnValuesArray[3] = _parentCategoriesRowByFK_dbo_Categories_dbo_Categories_ParentID[0];
                }
        ...
        public partial class CategoriesRow : global::System.Data.DataRow {
            ...
            public System.DateTime ModifileDate {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableCategories.ModifileDateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ModifileDate\' in table \'Categories\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCategories.ModifileDateColumn] = value;
                }
            }
            ...
            public CategoriesRow CategoriesRowParent {
                get {
                    return ((CategoriesRow)(this.GetParentRow(this.Table.ParentRelations["FK_dbo.Categories_dbo.Categories_ParentID"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_dbo.Categories_dbo.Categories_ParentID"]);
                }
            }
            ...
            public bool IsModifileDateNull() {
                return this.IsNull(this.tableCategories.ModifileDateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetModifileDateNull() {
                this[this.tableCategories.ModifileDateColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CategoriesRow[] GetCategoriesRows() {
                if ((this.Table.ChildRelations["FK_dbo.Categories_dbo.Categories_ParentID"] == null)) {
                    return new CategoriesRow[0];
                }
                else {
                    return ((CategoriesRow[])(base.GetChildRows(this.Table.ChildRelations["FK_dbo.Categories_dbo.Categories_ParentID"])));
                }
            }
        }
...
namespace FormCoffee.CategoryDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Categories] WHERE (([ID] = @Original_ID) AND ((@IsNull_ParentID = 1 AND [ParentID] IS NULL) OR ([ParentID] = @Original_ParentID)) AND ([Status] = @Original_Status) AND ((@IsNull_CreatedDate = 1 AND [CreatedDate] IS NULL) OR ([CreatedDate] = @Original_CreatedDate)) AND ((@IsNull_ModifileDate = 1 AND [ModifileDate] IS NULL) OR ([ModifileDate] = @Original_ModifileDate)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Categories] ([Name], [Slug], [ParentID], [Status], [CreatedDate], [ModifileDate]) VALUES (@Name, @Slug, @ParentID, @Status, @CreatedDate, @ModifileDate);
SELECT ID, Name, Slug, ParentID, Status, CreatedDate, ModifileDate FROM Categories WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Categories] SET [Name] = @Name, [Slug] = @Slug, [ParentID] = @ParentID, [Status] = @Status, [CreatedDate] = @CreatedDate, [ModifileDate] = @ModifileDate WHERE (([ID] = @Original_ID) AND ((@IsNull_ParentID = 1 AND [ParentID] IS NULL) OR ([ParentID] = @Original_ParentID)) AND ([Status] = @Original_Status) AND ((@IsNull_CreatedDate = 1 AND [CreatedDate] IS NULL) OR ([CreatedDate] = @Original_CreatedDate)) AND ((@IsNull_ModifileDate = 1 AND [ModifileDate] IS NULL) OR ([ModifileDate] = @Original_ModifileDate)));
SELECT ID, Name, Slug, ParentID, Status, CreatedDate, ModifileDate FROM Categories WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Slug, ParentID, Status, CreatedDate, ModifileDate FROM dbo.Categ" +
                "ories";
        ...
        public virtual int Fill(CategoryDataSet.CategoriesDataTable dataTable) {
        ...
        public virtual CategoryDataSet.CategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CategoryDataSet.CategoriesDataTable dataTable = new CategoryDataSet.CategoriesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CategoryDataSet.CategoriesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, global::System.Nullable<int> Original_ParentID, bool Original_Status, global::System.Nullable<global::System.DateTime> Original_CreatedDate, global::System.Nullable<global::System.DateTime> Original_ModifileDate) {
            ...
            if ((Original_ModifileDate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_ModifileDate.Value));
            }
            else {
        ...
        public virtual int Insert(string Name, string Slug, global::System.Nullable<int> ParentID, bool Status, global::System.Nullable<global::System.DateTime> CreatedDate, global::System.Nullable<global::System.DateTime> ModifileDate) {
            if ((Name == null)) {
            ...
            if ((ModifileDate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(ModifileDate.Value));
            }
            else {
        ...
        public virtual int Update(string Name, string Slug, global::System.Nullable<int> ParentID, bool Status, global::System.Nullable<global::System.DateTime> CreatedDate, global::System.Nullable<global::System.DateTime> ModifileDate, int Original_ID, global::System.Nullable<int> Original_ParentID, bool Original_Status, global::System.Nullable<global::System.DateTime> Original_CreatedDate, global::System.Nullable<global::System.DateTime> Original_ModifileDate, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            if ((ModifileDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(ModifileDate.Value));
            }
            else {
            ...
            if ((Original_ModifileDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_ModifileDate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Slug, global::System.Nullable<int> ParentID, bool Status, global::System.Nullable<global::System.DateTime> CreatedDate, global::System.Nullable<global::System.DateTime> ModifileDate, int Original_ID, global::System.Nullable<int> Original_ParentID, bool Original_Status, global::System.Nullable<global::System.DateTime> Original_CreatedDate, global::System.Nullable<global::System.DateTime> Original_ModifileDate) {
            return this.Update(Name, Slug, ParentID, Status, CreatedDate, ModifileDate, Original_ID, Original_ParentID, Original_Status, Original_CreatedDate, Original_ModifileDate, Original_ID);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        private int UpdateUpdatedRows(CategoryDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            ...
            if ((this._categoriesTableAdapter != null)) {
                ...
                if (((updatedRows != null) 
                    ...
                    this.SortSelfReferenceRows(updatedRows, dataSet.Relations["FK_dbo.Categories_dbo.Categories_ParentID"], false);
        ...
        private int UpdateInsertedRows(CategoryDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            ...
            if ((this._categoriesTableAdapter != null)) {
                ...
                if (((addedRows != null) 
                            && (0 < addedRows.Length))) {
                    this.SortSelfReferenceRows(addedRows, dataSet.Relations["FK_dbo.Categories_dbo.Categories_ParentID"], false);
        ...
        private int UpdateDeletedRows(CategoryDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            ...
            if ((this._categoriesTableAdapter != null)) {
                ...
                if (((deletedRows != null) 
                    ...
                    this.SortSelfReferenceRows(deletedRows, dataSet.Relations["FK_dbo.Categories_dbo.Categories_ParentID"], true);
